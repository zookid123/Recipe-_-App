...
class _RecipeCreateScreenState extends State<RecipeCreateScreen> {
          ...
          children: [
            Expanded(
              child: TextFormField(
                ...
                decoration: _inputDecoSuffix('칼로리', 'kcal'),
              ),
            ),
            ...
            Expanded(
              child: TextFormField(
                controller: _qntCtrl,
                keyboardType: TextInputType.number,
                decoration: _inputDecoSuffix('분량', '인분'),
              ),
            ),
          ],
        ),
          ...
          children: [
            Expanded(
              child: TextFormField(
                ...
                keyboardType: TextInputType.number,
                decoration: _inputDecoSuffix('조리 시간', '분'),
              ),
            ),
            const SizedBox(width: 10),
            Expanded(
              child: _buildDropdown('난이도', _level, [
                '초급',
                '중급',
                '고급',
              ], (v) => setState(() => _level = v!)),
  ...
  InputDecoration _inputDecoSuffix(String hint, String suffix) => InputDecoration(
    hintText: hint,
